...
// DataJud devolve "numeroProcesso" como 20 dígitos crus, sem pontuação
// (ex.: "10019502620255020016") - sem reformatar, a tela mostra um número
// ilegível em vez do padrão NNNNNNN-DD.AAAA.J.TR.OOOO que todo advogado
// reconhece. Devolve o valor original se não tiver exatamente 20 dígitos
// (não força formato em algo que não é um número CNJ).
