...
// Cookie httpOnly que guarda o access/refresh token do admin de verdade
// ANTES de trocar pra sessão de visualização (entrarComoAdvogado, em
// app/admin/actions.js) - é o que permite "voltarParaAdmin" (botão em
// Configurações) sem pedir a senha de novo. Nome fica aqui (não em
// admin-servidor.js) porque app/login/actions.js ("sair") também limpa
// esse cookie no logout normal, e esse arquivo é o único "puro"
// compartilhado pelos dois lados.
export const COOKIE_SESSAO_ADMIN_ORIGINAL = "sessao_admin_original";
